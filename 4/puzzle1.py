...
# Find board with minimal steps to win
min_index = -1
min = sys.maxsize
for b in range(len(board_winning_steps)):
    if board_winning_steps[b][0] < min:
        min_index = b
        min = board_winning_steps[b][0]


winning_board = boards[min_index]
winning_steps = board_winning_steps[min_index]
